...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "אפשר לבחור הובלה בלבד בתוספת ₪450, או הובלה והרכבה מקצועית בתוספת ₪2,350 (לדגם 3x4 — ₪2,840). ההובלה מתייחסת לפריקה מישורית עד 15 מטר ממקום החנייה; סבלות מעבר לכך בתוספת תשלום במזומן ישירות למתקינים. אפשר גם לחסוך את התוספת ולאסוף באיסוף עצמי. שירות ההרכבה ניתן רק יחד עם הובלה.",
  },
  {
    q: "מה זמן האספקה?",
