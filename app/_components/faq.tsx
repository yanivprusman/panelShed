...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "שישה גדלים סטנדרטיים: מ־2x2 מ' ועד 3x4 מ'. כל הדגמים בגובה 2.20–2.30 מ' עם גג חד־שיפועי. המחיר מחושב לפי מחירון החומרים העדכני, והמחיר הסופי נקבע לפי הגודל והתוספות שבוחרים במחירון שבעמוד.",
  },
  {
