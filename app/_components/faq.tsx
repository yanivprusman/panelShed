...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'בקטלוג יש דגם אחד — 2x2 מ\' (4 מ"ר), בגובה 2.20 מ\' בקיר הנמוך העולה ל־2.30 מ\' בגג החד־שיפועי. כל מידה אחרת נבנית לפי הזמנה במתכנן המחסן שבעמוד: בוחרים רוחב, עומק, גובה ופתחים, רואים את המחסן בתלת־ממד ומקבלים מחיר. המידות שאנחנו מוכרים באופן שוטף הן 1.5–5 מ\' לכל צלע, גובה 1.8–3 מ\' ועד 20 מ"ר — מעבר לכך עדיין נתמחר לכם את המחסן, בתיאום איתנו. בכל מקרה המחיר מחושב לפי מחירון החומרים העדכני, והמחיר הסופי נקבע לפי הגודל והתוספות שבוחרים במחירון שבעמוד.',
  },
  {
    q: "מה כולל שירות ההובלה וההרכבה?",
    a: 'אפשר לבחור הובלה בלבד בתוספת ₪450 בכל מידה, או הובלה והרכבה מקצועית שמחירה נקבע לפי שטח המחסן: ₪2,350 עד 9 מ"ר, ₪2,840 עד 12 מ"ר ו־₪3,150 עד 20 מ"ר. ההובלה מתייחסת לפריקה מישורית עד 15 מטר ממקום החנייה; סבלות מעבר לכך בתוספת תשלום במזומן ישירות למתקינים. אפשר גם לחסוך את התוספת ולאסוף באיסוף עצמי. שירות ההרכבה ניתן רק יחד עם הובלה.',
  },
  {
    q: "מה זמן האספקה?",
